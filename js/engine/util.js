...
(function () {
  ...
  g.util.rectIntersect = function (r0, r1) {
    return (
      g.util.rangeIntersect(r0.x, r0.x + r0.width, r1.x, r1.x + r1.width) &&
      g.util.rangeIntersect(r0.y, r0.y + r0.height, r1.y, r1.y + r1.height)
    );
  };
  ...
  g.util.format.time = function (seconds) {
    ...
    var seconds = g.m.floor(seconds % 60);
